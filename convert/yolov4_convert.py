...
weights= '/Data/jing/weights/detection/keras_tf/yolo/pretrain/yolov4.weights'#, 'path to weights file')
output= 'yolov4.tflite'             #, 'path to output')
tiny=False                   #, 'path to output')
input_size= 416          #, 'path to output')
