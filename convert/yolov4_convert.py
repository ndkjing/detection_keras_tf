...
flags.DEFINE_string('weights', '/Data/jing/weights/detection/keras_tf/yolo/pretrain/yolov4.weights', 'path to weights file')
flags.DEFINE_string('output', 'yolov4.tflite', 'path to output')
