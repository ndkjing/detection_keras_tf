'''
Miscellaneous insight_data generator utilities.
...
def apply_inverse_transforms(y_pred_decoded, inverse_transforms):
    ...
    insight_data generator return. This function would normally be used to transform predictions
