...
def predict_all_to_json(out_file,
    ...
    '''
    Runs detection predictions over the whole dataset given a weights and saves them in a JSON file
    ...
    Arguments:
        ...
        classes_to_cats (dict): A dictionary that maps the consecutive class IDs predicted by the weights
