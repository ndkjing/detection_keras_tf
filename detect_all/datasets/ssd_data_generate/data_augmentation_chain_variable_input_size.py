'''
A insight_data augmentation pipeline suitable for variable-size images that produces effects
that are similar (but not identical) to those of the original SSD insight_data augmentation
...
from datasets.ssd_data_generate.object_detection_2d_photometric_ops import ConvertColor, ConvertDataType, ConvertTo3Channels, RandomBrightness, RandomContrast, RandomHue, RandomSaturation
from datasets.ssd_data_generate.object_detection_2d_geometric_ops import Resize, RandomFlip
from datasets.ssd_data_generate.object_detection_2d_patch_sampling_ops import PatchCoordinateGenerator, RandomPatch
from datasets.ssd_data_generate.object_detection_2d_image_boxes_validation_utils import BoxFilter, ImageValidator
