'''
The insight_data augmentation operations of the original SSD implementation.
...
from datasets.ssd_data_generate.object_detection_2d_photometric_ops import ConvertColor, ConvertDataType, ConvertTo3Channels, RandomBrightness, RandomContrast, RandomHue, RandomSaturation, RandomChannelSwap
from datasets.ssd_data_generate.object_detection_2d_patch_sampling_ops import PatchCoordinateGenerator, RandomPatch, RandomPatchInf
from datasets.ssd_data_generate.object_detection_2d_geometric_ops import ResizeRandomInterp, RandomFlip
from datasets.ssd_data_generate.object_detection_2d_image_boxes_validation_utils import BoundGenerator, BoxFilter, ImageValidator
...
class SSDRandomCrop:
    ...
    strategy can also be found in the insight_data augmentation section of the paper:
...
class SSDDataAugmentation:
    '''
    Reproduces the insight_data augmentation pipeline used in the training of the original
