'''
A insight_data augmentation pipeline for datasets in bird's eye view, i.e. where there is
...
from datasets.ssd_data_generate.object_detection_2d_geometric_ops import Resize, RandomFlip, RandomRotate
