...
class DecodeDetections(Layer):
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            nms_max_output_size (int, optional): The maximum number of predictions that will be left after performing non-maximum
                suppression.
            coords (str, optional): The box coordinate format that the weights outputs. Must be 'centroids'
    ...
    def call(self, y_pred, mask=None):
        ...
        # If the weights predicts box coordinates relative to the image dimensions and they are supposed
