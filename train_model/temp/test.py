...
from train_model.temp.configuration import OBJECT_CLASSES, save_model_dir, test_picture_dir
from train_model.temp.inference import InferenceProcedure
from train_model.temp.ssd import SSD
from train_model.temp.tools import preprocess_image
